...
public class LeesAIPlayer extends AIPlayer {
  ...
  /**
   * Overall approach: 1. choose a minigrid for this turn, usually there's just
   * one 2. choose a minigrid for next turn 3. choose a cell for this turn,
   * based on either: a. make more glyph points in this grid b. go for next
   * turn's minigrid
   */
  @Override
  public GridPosition itsYourTurn() {
    /*
     * This particular (first crude attempt) does: 1. if there's more than one,
     * it just picks on at random. 2. skips this step. 3. goes for 3a, nothing
     * for 3b (because we didn't do #2 anyway).
     */
