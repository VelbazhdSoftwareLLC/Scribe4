...
public abstract class Settings {
  ...
  public static int getDisabledColorForMark(ScribeMark mark) {
    switch (mark) {
    case BLUE:
      return Color.rgb(Color.red(Color.BLUE)/2,Color.green(Color.BLUE)/2,Color.blue(Color.BLUE)/2);
    case RED:
      return Color.rgb(Color.red(Color.RED)/2,Color.green(Color.RED)/2,Color.blue(Color.RED)/2);
    case GREEN:
      return Color.rgb(Color.red(Color.GREEN)/2,Color.green(Color.GREEN)/2,Color.blue(Color.GREEN)/2);
    case PURPLE:
      return Color.rgb(Color.red(Color.MAGENTA)/2,Color.green(Color.MAGENTA)/2,Color.blue(Color.MAGENTA)/2);
    case EMPTY:
      return Color.rgb(Color.red(Color.WHITE)/2,Color.green(Color.WHITE)/2,Color.blue(Color.WHITE)/2);
    default:
      return Color.rgb(Color.red(Color.WHITE)/2,Color.green(Color.WHITE)/2,Color.blue(Color.WHITE)/2);
    }
  }
